...
func (_m *MockIClient) Download(ctx context.Context, bucketName string, path string) (*storage.ObjectHandle, []byte, error) {
	ret := _m.Called(ctx, bucketName, path)

	var r0 *storage.ObjectHandle
	var r1 []byte
	var r2 error
	if rf, ok := ret.Get(0).(func(context.Context, string, string) (*storage.ObjectHandle, []byte, error)); ok {
...
func (_c *MockIClient_Download_Call) Return(obj *storage.ObjectHandle, data []byte, err error) *MockIClient_Download_Call {
	_c.Call.Return(obj, data, err)
	return _c
}

func (_c *MockIClient_Download_Call) RunAndReturn(run func(context.Context, string, string) (*storage.ObjectHandle, []byte, error)) *MockIClient_Download_Call {
	_c.Call.Return(run)
	return _c
}
