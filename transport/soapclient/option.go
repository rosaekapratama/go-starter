...
func (o *loggingOption) Apply(_ context.Context, client *Client) error {
	client.transport.logging = &clientLogging{
		Stdout:   o.stdout,
		Database: o.database,
	}
	return nil
...
func (o *insecureSkipVerifyOption) Apply(_ context.Context, client *Client) error {
	if o.insecureSkipVerify {
		if client.transport.transport.TLSClientConfig == nil {
			client.transport.transport.TLSClientConfig = &tls.Config{}
		}
		client.transport.transport.TLSClientConfig.InsecureSkipVerify = o.insecureSkipVerify
	}
	return nil
}
